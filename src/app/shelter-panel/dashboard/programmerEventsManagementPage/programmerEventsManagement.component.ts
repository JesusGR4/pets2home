...
@Component({
    selector: "programmerEventsManagement",
    templateUrl: "./programmerEventsManagement.component.html",

})
export class ProgrammerEventsManagement {
    ...
    getActiveEventsList(filter) : void{
        this._eventsService.getActiveList(filter, ProfilesService.CINEMAS_PROGRAMMER_PROFILE_ID).subscribe(
                res => {
                let json = res.json();
                let code = json.code;
    ...
    getCompletedEventsList(filter) : void{
        this._eventsService.getCompletedList(filter, ProfilesService.CINEMAS_PROGRAMMER_PROFILE_ID).subscribe(
                res => {
                let json = res.json();
                let code = json.code;
                let message = json.message;
    ...
    getCanceledEventsList(filter) : void{
        this._eventsService.getCanceledList(filter, ProfilesService.CINEMAS_PROGRAMMER_PROFILE_ID).subscribe(
                res => {
                let json = res.json();
                let code = json.code;
                let message = json.message;
