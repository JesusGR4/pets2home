...
@Component({
    selector: "programmerAdminFilmManagement",
    templateUrl: "./programmerFilmManagement.component.html",

})
export class ProgammerFilmManagement {
    ...
    getMovieList(){
        this._moviesService.getList(this.currentPage, this.filter, ProfilesService.CINEMAS_PROGRAMMER_PROFILE_ID).subscribe(
            res => {
                let json = res.json();
                let code = json.code;
    ...
    saveMovie(){
        this._moviesService.createMovie(this.auxMovie, this.session.id, ProfilesService.CINEMAS_PROGRAMMER_PROFILE_ID).subscribe(
            res => {
                let json = res.json();
                let code = json.code;
                let message = json.message;
