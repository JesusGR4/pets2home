...
var Slider_index = function(jQuery){
...
$(document).ready(function () {
    ...
    if (!isMobile) {
        jQuery(".top-login a.login-submenu, .login-submenu-content").hover(function () {
            jQuery(".login-submenu-content").css('opacity', '1');
            jQuery(".login-submenu-content").css('visibility', 'visible');
        }, function () {
            jQuery(".login-submenu-content").css('opacity', '0');
            jQuery(".login-submenu-content").css('visibility', 'hidden');
        });
    }
    if (isiPhoneiPad) {
    ...
    jQuery(".top-login a.login-submenu").click(function () {
        //$('.navbar-collapse').collapse('hide');

        if ($('.login-submenu-content').css('visibility') == 'visible') {
            jQuery(".login-submenu-content").css('opacity', '0');
            jQuery(".login-submenu-content").css('visibility', 'hidden');
        }
        else {
    ...
    $('.navbar .navbar-collapse a.dropdown-toggle, .accordion-style1 .panel-heading a, .accordion-style2 .panel-heading a, .accordion-style3 .panel-heading a, .toggles .panel-heading a, .toggles-style2 .panel-heading a, .toggles-style3 .panel-heading a, a.carousel-control, .nav-tabs a[data-toggle="tab"], a.login-submenu').click(function (e) {
        e.preventDefault();
    });
